...
String? getColorCodeFromName(String colorName) {
  for (int i = 0; i < colorMap.length; i++) {
    if (colorMap.entries.elementAt(i).value.toString().toLowerCase() ==
        colorName.toLowerCase()) {
      var temp = colorMap.entries.elementAt(i).key;
      return temp;
    }
  }
  return null;
...
Color getColorsFromName(String colorName) {
  String? hexColorCode = getColorCodeFromName(colorName);
